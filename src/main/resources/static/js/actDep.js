...
async function crearActividades(var1) {
    try {
        var url = 'http://localhost:8888/SaguntoKids/actividades/deportivas';
        switch (var1) {
            case 1:
                url = 'http://localhost:8888/SaguntoKids/actividades/deportivasAsc'
                break;
            case 2:
                url = 'http://localhost:8888/SaguntoKids/actividades/deportivasDesc'
                break
            case 3:
                url = 'http://localhost:8888/SaguntoKids/actividades/deportivasAlf'
                break    
        }
        ...
        let contenido = document.querySelector("main > section:nth-of-type(2)");
