...
async function crearActividades(var1) {
    try {
        var url = 'http://localhost:8888/SaguntoKids/actividades/formativas';
        switch (var1) {
            case 1:
                url = 'http://localhost:8888/SaguntoKids/actividades/formativasAsc'
                break;
            case 2:
                url = 'http://localhost:8888/SaguntoKids/actividades/formativasDesc'
                break
            case 3:
                url = 'http://localhost:8888/SaguntoKids/actividades/formativasAlf'
                break    
        }
